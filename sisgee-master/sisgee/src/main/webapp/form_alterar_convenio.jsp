...
<html lang="en">
    <head>
        ...
        <title>
            <fmt:message key = "br.cefetrj.sisgee.resources.form.alteracaoConvenio"/>
        </title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="tituloForm ">
            <h5 class="offset-5"><fmt:message key="br.cefetrj.sisgee.resources.form.alteracaoConvenio" /></h5>		



                <fieldset class="form-group col-auto offset-1">

                    <form action="ValidaBuscarAlteracaoConvenioServlet" method="GET" >
