                ...
                <fieldset class="form-group">
                    ...
                    <div class=" notAI AI" ${ empty param.tipoPessoa ? "style='display:none'" : param.tipoPessoa == "sim" ? "style='display:none'" : "" } >
                        <div class="form-row "  >
                            ...
                            <input type="text" class="form-control ${ not empty numeroConvenioMsg ? 'is-invalid': 'is-valid' }" id="numeroConvenio" name="numeroConvenio" maxlength="16" value="${ param.numeroConvenio }">
                            ...
                            <input type="text" class="form-control ${ not empty anoMsg ? 'is-invalid': 'is-valid' }" id="ano" name="ano" maxlength="4" value="${ param.ano }">
                            <c:if test="${ not empty anaMsg }">
